    ...
    <section id="translator" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-navy mb-4">Sign Language Translator</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our translator converts between Different Sign Language and text in real-time. 
        ...
        <Tabs defaultValue="asl-to-text" className="max-w-5xl mx-auto">
          ...
          <TabsContent value="courses" className="mt-6">
            ...
            <div className="mt-10 text-center">
              <h3 className="text-xl font-bold text-navy mb-4">Why Learn Sign Language?</h3>
